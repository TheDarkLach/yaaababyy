...
class music(commands.Cog):
    ...
    @commands.command(help = 'brings scoob to vc')
    ...
    @commands.command(help = 'adjusts volume (does not work)')
    ...
    @commands.command(help = 'display current song')
    ...
    @commands.command(help = 'resume music')
    ...
    @commands.command(help = 'displays queue')
    ...
    @commands.command(help = 'show songs played during this session')
    ...
    @commands.command(help = 'remove a song in the queue')
    ...
    @commands.command(help = 'loops a song')
    ...
    @commands.command(help = 'doesnt even work so who cares')
    ...
    @commands.command(help = 'doesnt work either')

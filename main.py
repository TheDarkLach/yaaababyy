...
async def on_message(message):
  ...
  if client.user != message.author:
      ...
      if message.author.id == 888925448954871868:
        await message.channel.send("<@888925448954871868> suckin milk outta your moms titties like fine wine")
      ...
      if message.content.lower() == 'kuzy':
        await message.channel.send('your name is joe, ur opinion is irrelevant')
      ...
      if message.content.lower() == 'tucker':
        await message.channel.send('god he gives me such a raging boner lord have mercy')
      ...
      if message.content.lower() == 'balls':
        await message.reply("https://tenor.com/view/balls-love-struck-lick-tongue-gif-14644911")
      if 'ass' in message.content:
        print(assd)
        if assd % 2 == 0:
          return
        else:
          await message.reply('https://cdn.discordapp.com/emojis/627664851531071518.gif?v=1')  
      if message.content.lower() == 'kiss me':
        await message.reply('https://tenor.com/view/caught-in-4k-caught-in4k-chungus-gif-19840038')
...
async def president(ctx):
  embed=discord.Embed(title="This is your president:", description="Sup dawgs it's me, ya boy, president Not BN. In my offtime I like long walks on the beach during sunset. Otherwise i'm fuckin bitches in my 3 story condo. bih yah peace out", color=0x19B9B9)
  embed.set_author(name="President Not BN", url="https://twitter.com/LachDark", icon_url="https://pbs.twimg.com/profile_images/1397996923508781058/CNBym2zc_400x400.jpg")
